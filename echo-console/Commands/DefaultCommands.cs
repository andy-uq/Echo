        ...
        sealed class BuiltInCommands
        {
            ...
            internal static class BuiltIn
            {
                public static ICommand[] Commands
                {
                    get
                    {
                        ...
                        foreach (MethodInfo mi in t.GetMethods(BindingFlags.Public | BindingFlags.Static | BindingFlags.InvokeMethod))
                            if (!mi.IsSpecialName)
                                cmds.Add(global::Echo.ConsoleRunner.Commands.Command.Make(t, mi));
                        return cmds.ToArray();
                    }
                }
                ...
                public static void Echo(
				    ...
				    string[] args)
                {
                    System.Console.WriteLine(ArgumentList.EscapeArguments(args));
                }
                    ...
                    )
                {
                    ...
                    TextReader rdr = System.Console.In;
                    ...
                    try
                    {
                        ...
                        while (null != (line = rdr.ReadLine()))
                        {
                            ...
                            {
                                counter++;
                                if (!count) System.Console.WriteLine(line);
                            }
                        }
                ...
                public static void More(ICommandInterpreter ci)
                {
                    ...
                    string line;
                    while (null != (line = System.Console.ReadLine()))
                    {
