...
namespace Echo.ConsoleRunner.Commands
{
	...
	partial class Argument : DisplayInfoBase, IArgument
	{
		...
		{
			get { return (ParameterInfo) base.Member; }
		}

		private Type UnderlyingType
		{
			get { return Nullable.GetUnderlyingType(Parameter.ParameterType) ?? Parameter.ParameterType; }
		}
		...
		{
			get { return base.Visible && !IsInterpreter && !IsAllArguments; }
		}
		...
		public bool IsFlag
		{
			get { return Parameter.ParameterType == typeof (bool); }
		}

		public bool IsInterpreter
		{
			get { return Parameter.ParameterType == typeof (ICommandInterpreter); }
		}

		public bool IsAllArguments
		{
