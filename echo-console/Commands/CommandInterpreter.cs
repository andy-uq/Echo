...
using System.IO;
using CommandTypes = global::Echo.ConsoleRunner.Commands.DefaultCommands;
...
namespace Echo.ConsoleRunner.Commands
{
	...
	public partial class CommandInterpreter : ICommandInterpreter
	{
		...
		public CommandInterpreter(params object[] handlers)
			: this(DefaultCommands.Default, handlers) { }
		/// <summary>
		/// Constructs a command-line interpreter from the objects and/or System.Types provided.
		/// </summary>
		...
		public object Get(string property)
		{
			...
			System.Console.Out.WriteLine("{0}", value);
			return value;
		}
			...
			[DefaultValue(false),Description("Read from std::in lines formatted as NAME=VALUE")]bool readInput)
		{
			...
			{
				string line;
				while (null != (line = System.Console.In.ReadLine()))
					Set(line, null, false);
				return;
			}
			if (property == null)
			{
				foreach (IOption opt in Options)
					System.Console.WriteLine("{0}={1}", opt.DisplayName, opt.Value);
				return;
			}
		...
		protected virtual void OnError(Exception error)
		{
			...
			{/* Silent */}
				...
				System.Console.Error.WriteLine(error is ApplicationException ? error.Message : error.ToString());
		...
		public void Run(System.IO.TextReader input)
		{
			...
			try
			{
				while (true)
				{
					try
					{
						System.Console.Write(ExpandOptions(Prompt));
        ...
        private sealed class ConsoleOutput : ConsoleWriter
        {
            ...
            public static TextWriter Capture(TextWriter output)
            {
                ...
                lock (typeof (System.Console))
                {
                    ...
                    {
                        _default = System.Console.Out;
                        System.Console.SetOut(_instance);
                        _expected = System.Console.Out;
                    }
                    else if (!ReferenceEquals(_expected, System.Console.Out))
                    {
                        System.Console.SetOut(_instance);
                        _expected = System.Console.Out;
                    }
            ...
            public static void Restore(TextWriter replaced, TextWriter original)
            {
                ...
                lock (typeof (System.Console))
                {
                    ...
                    {
                        System.Console.SetOut(_default);
                        _default = null;
                    }
                    else if (!ReferenceEquals(_expected, System.Console.Out))
                    {
        ...
        private sealed class ConsoleError : ConsoleWriter
        {
            ...
            public static TextWriter Capture(TextWriter output)
            {
                ...
                lock (typeof(System.Console))
                {
                    if (1 == Interlocked.Increment(ref _referenceCount))
                    {
                        _default = System.Console.Error;
                        System.Console.SetError(_instance);
                        _expected = System.Console.Error;
                    }
                    else if (!ReferenceEquals(_expected, System.Console.Error))
                    {
                        System.Console.SetError(_instance);
                        _expected = System.Console.Error;
                    }
            ...
            public static void Restore(TextWriter replaced, TextWriter original)
            {
                ...
                lock (typeof(System.Console))
                {
                    ...
                    if (0 == Interlocked.Decrement(ref _referenceCount))
                    {
                        System.Console.SetError(_default);
                        _default = null;
                    }
                    else if (!ReferenceEquals(_expected, System.Console.Error))
                    {
        ...
        private sealed class ConsoleInput : TextReader
        {
            ...
            public static TextReader Capture(TextReader output)
            {
                ...
                lock (typeof(System.Console))
                {
                    if (1 == Interlocked.Increment(ref _referenceCount))
                    {
                        _default = System.Console.In;
                        System.Console.SetIn(_instance);
                        _expected = System.Console.In;
                    }
                    else if (!ReferenceEquals(_expected, System.Console.In))
                    {
                        System.Console.SetIn(_instance);
                        _expected = System.Console.In;
                    }
